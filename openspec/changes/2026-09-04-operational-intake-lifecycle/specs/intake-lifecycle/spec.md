# Specification: Operational Intake Queue Lifecycle

## Purpose
Define the operational lifecycle for raw PDF documents in `input/`, ensuring binary deduplication, classification-based entry, mandatory semantic review, and safe orchestration via public APIs.
