# itp-ingress-preflight-evidence Specification

## Purpose
Define the Stage 2 contract for receiving ITP/1.0 single-evidence filesystem handoffs, safely validating transport and PDF evidence, computing the official receiver SHA-256 over exact accepted bytes, preserving accepted evidence before Phase 1, and enforcing retry/idempotency and Zero-Write isolation from the canonical bundle.
## Requirements
